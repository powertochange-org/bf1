...
<div id="reports">
  <div id="list">
    <div class="report" id="disciples_report">
      <div class="title corners-left">
        <div class="reporticon"></div>
        <div class="name">My Disciples</div>
      </div>
      <div class="descr">Lists the responses by disciple where the coaches flag has been checked</div>
      <a class="run ui-state-default corners-all button" href="?p=reports&id=disciples_report"><span class="ui-icon ui-icon-gear"></span>Run</a>
    </div>
    <div class="report" id="progress_report">
      <div class="title corners-left">
        <div class="reporticon"></div>
