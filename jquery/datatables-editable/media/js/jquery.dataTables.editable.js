        ...
        return this.each(function () {
            ...
            if (oAddNewRowForm.length != 0) {
                ...
                if (oConfirmRowAddingButton.length == 0) {
                    ...
                    if (properties.oAddNewRowOkButtonOptions.label == null
                        || properties.oAddNewRowOkButtonOptions.label == "") {
                        properties.oAddNewRowOkButtonOptions.label = "Ok";
                    }
                ...
                if (oCancelRowAddingButton.length == 0) {
                    ...
                    if (properties.oAddNewRowCancelButtonOptions.label == null
                        || properties.oAddNewRowCancelButtonOptions.label == "") {
                        properties.oAddNewRowCancelButtonOptions.label = "Cancel";
                    }
